...
int main() {
    ...
    // Adding three Nodes
    // a) Adding a node at head 

    Student* student11 = new Student{ "olomi", 4563, nullptr};
    student11->link = student1;

    head = student1;

    // b) Adding a node at the end
    Student* student12 = new Student{ "junior", 3450, nullptr};
    student10->link = student12;

    // c) Adding a node after the fifth node
    Student* student13 = new Student{ "john", 3452, nullptr};
    student13->link = student4->link;
    student4->link = student13;
